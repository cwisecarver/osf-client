...
function open(e){return new Promise(function(t,r){var o=e.fullUrl(),n=e.method,s=e.options.responseType;if("https:"===window.location.protocol&&/^http\:/.test(o))return r(e.error('The request to "'+o+'" was blocked',"EBLOCKED"));var a=e.raw=new XMLHttpRequest;a.onload=function(){return t({status:1223===a.status?204:a.status,statusText:a.statusText,rawHeaders:parseToRawHeaders(a.getAllResponseHeaders()),body:s?a.response:a.responseText,url:a.responseURL})},a.onabort=function(){return r(e.error("Request aborted","EABORT"))},a.onerror=function(){return r(e.error('Unable to connect to "'+e.fullUrl()+'"',"EUNAVAILABLE"))},a.onprogress=function(t){t.lengthComputable&&(e.downloadLength=t.total),e.downloadedBytes=t.loaded},"GET"!==n&&"HEAD"!==n&&a.upload?a.upload.onprogress=function(t){t.lengthComputable&&(e.uploadLength=t.total),e.uploadedBytes=t.loaded}:(e.uploadLength=0,e.uploadedBytes=0);try{a.open(n,o)}catch(u){return r(e.error('Refused to connect to "'+o+'"',"ECSP",u))}if(e.options.withCredentials&&(a.withCredentials=!0),s)try{a.responseType=s}finally{if(a.responseType!==s)throw e.error("Unsupported response type: "+s,"ERESPONSETYPE")}Object.keys(e.headers).forEach(function(t){a.setRequestHeader(e.name(t),e.get(t))}),a.send(e.body)})}function abort(e){e.raw.abort()}function parseToRawHeaders(e){for(var t=[],r=e.replace(/\r?\n$/,"").split(/\r?\n/),o=0;o<r.length;o++){var n=r[o],s=n.indexOf(":"),a=n.substr(0,s).trim(),u=n.substr(s+1).trim();t.push(a,u)}return t}var Promise=require("native-or-bluebird"),common_1=require("./common"),index_1=require("./plugins/index");module.exports=common_1.defaults({transport:{open:open,abort:abort,use:index_1.defaults}});
},{"./common":15,"./plugins/index":18,"native-or-bluebird":8}],13:[function(require,module,exports){
module.exports=FormData;
},{}],14:[function(require,module,exports){
module.exports=function(){throw new TypeError("Cookie jars are only available on node")};
...
function __export(o){for(var r in o)exports.hasOwnProperty(r)||(exports[r]=o[r])}__export(require("./common"));var common_2=require("./common");exports.defaults=[common_2.stringify,common_2.headers,common_2.parse];
